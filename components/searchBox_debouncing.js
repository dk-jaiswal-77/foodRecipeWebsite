...
function dilemma_for_network_request()
    ...
    function display_mealRecipe(meal)
    {
        ...
        let vid_id = meal.strYoutube.slice(32);
        // console.log(vid_id);
    ...
    export {dilemma_for_network_request, make_network_request, show_searchList, show_searchedMeal_recipe, get_meal_recipe_by_id, display_mealRecipe};
// --------------------------------------------------------------------------------------------->